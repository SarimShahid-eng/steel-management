@extends('partials.app', ['title' => 'Create Expense Payment'])
 ...
 <x-toast-fetch-error />
        ...
        <div class="p-4 mx-auto max-w-screen-2xl md:p-6">
            ...
            <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h2 class="text-title-sm font-semibold text-gray-800 dark:text-white/90">New Expense Payment</h2>
                    <p class="mt-0.5 text-theme-sm text-gray-500 dark:text-gray-400">Record an expense payment and update
                ...
                <a href="{{ route('expensePayment.index') }}"
                    ...
                    Back to Expense Payments
                </a>
            </div>

            <form method="POST" action="{{ route('expensePayment.store') }}" x-data="expenseForm()">
                @csrf

                {{-- ── SECTION 1: Expense Payment Details ── --}}
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] mb-5">

                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        <h3 class="text-base font-medium text-gray-800 dark:text-white/90">Expense Payment Details</h3>
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Select the expense account, payment
                        ...
                        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                            ...
                            <div>
                                <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                    Expense Payment Account <span class="text-error-500">*</span>
                                </label>
                                <div class="relative">
                                    <select name="account_id" x-model="expenseAccountId" @class([
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="date" name="date"
                                        value="{{ old('date', now()->format('Y-m-d')) }}" @class([
                ...
                <div class="rounded-2xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-white/[0.03] mb-5 overflow-hidden"
                    x-show="expenseAccountId && paymentType">
                    ...
                    <div class="divide-y divide-gray-100 dark:divide-gray-800">
                        <div class="flex items-center justify-between px-5 py-3">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-sm text-gray-700 dark:text-gray-300">Expense Payment account</span>
                            </div>
    ...
    @push('scripts')
        <script>
            function expenseForm() {
                return {
                    expenseAccountId: '{{ old('account_id', '') }}',
