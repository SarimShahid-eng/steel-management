    ...
    <div class="col-span-12 space-y-6 xl:col-span-12">
        ...
        <div class="flex flex-col gap-3 mb-6 sm:flex-row sm:items-center sm:justify-between px-3">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Manage stock sales</p>
            </div>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        @forelse($sales as $index => $sale)
                            <tr class="hover:bg-gray-50 dark:hover:bg-white/[0.02] transition-colors">
                                ...
                                <td
                                    class="py-3 px-4 text-sm text-right {{ $sale->remaining_amount > 0 ? 'text-error-500' : 'text-gray-400' }}">
