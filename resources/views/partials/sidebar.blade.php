                ...
                <ul class="flex flex-col gap-4 mb-6">
                    ...
                    <li>
                        <a href="{{ route('product.index') }}"
                            class="menu-item group
                            {{ request()->routeIs('product.*') ? 'menu-item-active' : 'menu-item-inactive' }}">
                    ...
                    <li>
                        <a href="{{ route('suppliers.index') }}"
                            class="menu-item group
                            {{ request()->routeIs('suppliers.*') ? 'menu-item-active' : 'menu-item-inactive' }}">
                    ...
                    <li>
                        <a href="{{ route('customers.index') }}"
                            class="menu-item group
                            {{ request()->routeIs('customers.*') ? 'menu-item-active' : 'menu-item-inactive' }}">
                    ...
                    <li>
                        <a href="{{ route('bankCash.index') }}"
                            class="menu-item group
                            {{ request()->routeIs('bankCash.*') ? 'menu-item-active' : 'menu-item-inactive' }}">
                    ...
                    {{-- <li>
                        <a href="{{ route('capitalDeposit.index') }}"
                            class="menu-item group
                            {{ request()->routeIs('capitalDeposit.*') ? 'menu-item-active' : 'menu-item-inactive' }}">
                    ...
                    <li>
                        <a href="{{ route('expenses.index') }}"
                            class="menu-item group
                            {{ request()->routeIs('expenses.*') ? 'menu-item-active' : 'menu-item-inactive' }}">
                    ...
                    <li>
                        <a href="{{ route('expensePayment.index') }}"
                            class="menu-item group
                            {{ request()->routeIs('expensePayment.*') ? 'menu-item-active' : 'menu-item-inactive' }}">
                    ...
                    <li>
                        <a href="{{ route('purchase.index') }}"
                            class="menu-item group
                            {{ request()->routeIs('purchase.*') ? 'menu-item-active' : 'menu-item-inactive' }}">
                    ...
                    <li>
                        <a href="{{ route('sale.index') }}"
                            class="menu-item group
                            {{ request()->routeIs('sale.*') ? 'menu-item-active' : 'menu-item-inactive' }}">
