<div
    ...
    <div class="max-w-full  custom-scrollbar">
        <div class="-ml-5 min-w-[650px] pl-2 xl:min-w-full">
            <div id="purchaseChart" data-series='@json($purchaseChartData)' class="-ml-5 h-full min-w-[650px] pl-2 xl:min-w-full"></div>
        </div>
    </div>
</div>
@push('scripts')
    <script>
        // Make the data available globally before the compiled JS runs
        window.purchaseChartData = @json($purchaseChartData);
    </script>
@endpush
